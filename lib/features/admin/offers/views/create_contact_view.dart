          ...
          children: [
            ...
            CountryPickerPhoneField(
              ...
              onPhoneChanged: (phone) {
                log('Phone changed: $phone');
              },
              onCountryChanged: (country) {
                log('Country changed: ${country.name} (+${country.phoneCode})');
              },
            ),
            ...
            14.verticalSpace,
            CustomDropDownField(labelText: 'Payment Terms', isRequired: true),
            10.verticalSpace,
            Row(
              ...
              children: [
                ...
                Checkbox(
                  ...
                  activeColor:
                      AppColors.primary, // Background color when checked
